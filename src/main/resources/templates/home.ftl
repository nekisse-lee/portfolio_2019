...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      ...
      <span class="d-none d-lg-block">
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/증명사진.png" alt="">
      </span>
    </a>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="ABOUT">
      <div class="w-100">
        <h1 class="mb-0">
          <span class="text-primary">${about.userName}</span>
        </h1>
        <div class="subheading mb-5"> ${about.phoneNumber}
          <a href="mailto:nekisse1224@gmail.com">${about.email}</a>
        </div>
        ...
        <div class="social-icons">
          ...
          <#--</a>-->
          <a href="https://github.com/nekisse-lee">
            <i class="fab fa-github"></i>
          </a>
          <#--<a href="#">-->
